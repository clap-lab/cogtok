...
- Dutch: [1](https://web.archive.org/web/20230415114120/http://crr.ugent.be/papers/dlp2_trials0.tsv.zip), [2](https://web.archive.org/web/20230415114120/http://crr.ugent.be/papers/dlp2_trials1.tsv.zip)
- [English](https://osf.io/6tdnz) ([backup](https://web.archive.org/web/20211129174823/http://crr.ugent.be/blp/txt/blp-items.txt.zip))
...
For the morphological analysis, we used the derivational data from [morphynet](https://github.com/kbatsuren/MorphyNet).
