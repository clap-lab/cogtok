Important note: 
The output.csv files in this folder contain the columns "reading time" and "accuracy". After I generated them, I adjusted the Spanish evaluation data to remove the extreme outliers (see data/eval/preprocessing). That is why these columns do not contain the correct values anymore. For evaluation, I use the preprocessed evaluation files. 
